...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python_abi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python_abi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install python_abi
```
...
It is possible to list all of the versions of `python_abi` available on your platform:
...
```
pixi search python_abi --channel conda-forge
```
